...
SELECT 
		...
		,cast(ANTIFIBEPLOAD as integer) IANTIFIBEPLOAD
		,cast(ANTIFIBEPPRIME as integer) IANTIFIBEPPRIME
		,cast(ANTIFIBEPINFRATE as integer) IANTIFIBEPINFRATE
		,cast(ISNULL(ANTIFIBTRANEXUSE,2) as integer) ANTIFIBTRANEXUSE
		,cast(ANTIFIBTRANEXLOAD as integer) IANTIFIBTRANEXLOAD
		,cast(ANTIFIBTRANEXPRIME as integer) IANTIFIBTRANEXPRIME
		,cast(ANTIFIBTRANEXINFRATE as integer) IANTIFIBTRANEXINFRATE
