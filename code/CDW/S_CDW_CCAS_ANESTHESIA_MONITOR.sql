...
WHERE 1=1
  --AND SERVICE.SRC_ID = 910 --Cardiac Service 
    --AND SERVICE.SRC_ID IN (4.0030,7.0030,910.0000,923.0000) --CT Surgery and Cardiology Services
...
where 1=1
  ...
  AND lda_fs.FS_ID IN (40008000,40010017,40007080,40007073) --  UAC SINGLE AND UAC DOUBLE LUMENS, ARTERIAL LINE
...
,TMPSITE AS
		...
		WHERE FLOW.FS_ID IN (40000303) --134071,148995,149098,148987,148979,149089,)
...
FROM
	...
	where 1=1
	  AND vsr.SEQ_NUM = fm.OCCURANCE /*Necessary to match the specific instance of the flowsheet recording to the correct measure value*/
	  AND lda_group_dict.SRC_ID in (36,2,46,1) -- PICC, CVA, LA OR RA
