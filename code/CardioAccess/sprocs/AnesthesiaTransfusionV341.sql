...
*/
CREATE OR ALTER PROCEDURE sp_CHOP_CCAS_ANESTHESIA_TRANSFUSION  as
		...
		BEGIN
					  ...
					  BEGIN
						...
						BEGIN TRAN
							...
							SET ANEST_TRGT.AutologousTrans=ANEST_SRC.AutologousTrans,
								...
								ANEST_TRGT.TransfusBldProdBefore=ANEST_SRC.TRANSFUSION,
								ANEST_TRGT.TRANSFUSBLDPRODANY=ANEST_SRC.TRANSFUSBLDPRODANY,
								ANEST_TRGT.BLDPRODPRBCMLBEF=ANEST_SRC.BLDPRODPRBCDUR,
								ANEST_TRGT.BLDPRODFFPMLBEF=ANEST_SRC.BLDPRODFFPDUR,
								ANEST_TRGT.BLDPRODFRESHPMLBEF=ANEST_SRC.BLDPRODFRESHPDUR,
								ANEST_TRGT.BLDPRODCRYOMLBEF=ANEST_SRC.BLDPRODCRYODUR,
								ANEST_TRGT.BLDPRODFRESHWBMLBEF=ANEST_SRC.BLDPRODFRESHWBDUR,
                                ANEST_TRGT.BLDPRODWBMLBEF=ANEST_SRC.BLDPRODWBDUR, 
								LastUpdate = GetDate(), 
			...
			ELSE IF EXISTS(SELECT C.CaseNumber FROM Cases C INNER JOIN @AnestCaseList AC ON C.CaseNumber = AC.CaseNumber WHERE AC.RowID = @i)
				...
				BEGIN TRY
				   BEGIN
					BEGIN TRAN
						INSERT INTO dbo.Transfusion (Casenumber,AutologousTrans,CELLSAVSAL,TransfusBldProdBefore,TRANSFUSBLDPRODANY,BLDPRODPRBCMLBEF,BLDPRODFFPMLBEF,BLDPRODFRESHPMLBEF,BLDPRODCRYOMLBEF,BLDPRODFRESHWBMLBEF, BLDPRODWBMLBEF,CreateDate,LastUpdate,UpdatedBy)
						SELECT AC.CaseNumber,AutologousTrans,CELLSAVSAL,TRANSFUSION,TRANSFUSBLDPRODANY,BLDPRODPRBCDUR,BLDPRODFFPDUR,BLDPRODFRESHPDUR,BLDPRODCRYODUR,BLDPRODFRESHWBDUR,BLDPRODWBDUR, GetDate(), GetDate(), 'CHOP_AUTOMATION' 
