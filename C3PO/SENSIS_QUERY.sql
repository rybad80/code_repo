...
--CASEEOCADMDISPOSITION		
		...
		CASE WHEN APTVER2.PTSTAT in (4,7) THEN 'PCL01' --ICU
		     WHEN APTVER2.PTSTAT in (3,6) THEN 'PCL02' --Stepdown
		     WHEN APTVER2.PTSTAT =  (5) THEN 'PCL03' -- General Floor
		     WHEN APTVER2.PTSTAT = (2) THEN 'PCL04' -- OutPatient
