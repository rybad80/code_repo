...
/* stg_nursing_metric_workforce_set_d
aggregates and gaps for time stages tables combined 
*/
{% set refs = [
    ref('stg_nursing_time_w3_fte'),
    ref('stg_nursing_time_w4_percent'),
    ref('stg_nursing_time_w5_variance'),
    ref('stg_nursing_time_w6_flex_gap'),
    ref('stg_nursing_time_w7_productive_budget'),
    ref('stg_nursing_w_k1_time_percent'),
    ref('stg_nursing_w_k2_replacement_factor'),
    ref('stg_nursing_w_k3_prdctvty_index')
] %}
