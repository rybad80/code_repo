...
select
	...
	(case
        when
            ...
            ) like '%mechanical circulatory support%'
            then 1
        else 0
...
inner join
    ...
    on usnews_metadata_calendar.question_number = 'e37.3'
left join
...
where
	...
	and primary_proc_id_32 in ('1110', '1120', '1123', '1125', '1130', '1140', '1145', '1150', '1160', '2210')
...
where
	...
	and diaglist.stsid30 in ('880', '890', '900', '910')
