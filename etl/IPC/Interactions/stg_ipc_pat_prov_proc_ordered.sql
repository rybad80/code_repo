with proc_ord as (
    select
        ...
        procedure_order.ordering_prov_key as prov_key,
    ...
    where
        procedure_order.ordering_prov_key != 0
    group by
        procedure_order_clinical.visit_key,
        procedure_order.ordering_prov_key,
...
select
    ...
    proc_ord.event_date,
    'procedure ordered' as event_description,
