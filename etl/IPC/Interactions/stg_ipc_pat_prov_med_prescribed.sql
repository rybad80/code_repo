with med_orders as (
    select
        ...
        medication_order.presc_prov_key as prov_key,
    ...
    where
        medication_order.presc_prov_key != 0
        and medication_order.presc_prov_key != medication_order.auth_prov_key
        and medication_order.presc_prov_key != medication_order.med_ord_prov_key
    group by
        medication_order.visit_key,
        medication_order.presc_prov_key,
...
select
    ...
    'medication prescribed' as event_description,
