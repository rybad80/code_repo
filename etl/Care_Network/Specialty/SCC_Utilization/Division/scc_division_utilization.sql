...
division_room_utilization as (
	...
	where (lower(room_type) like '%overfill%'
		or exam_room_ind = 1) -- division-level utilization metrics include exam rooms and overfill rooms
...
select * from division_room_utilization
