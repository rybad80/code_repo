select
    'CCPM: Outpatient Visits' as metric_name,
    frontier_ccpm_encounter_cohort.visit_key as primary_key,
    frontier_ccpm_encounter_cohort.visit_type as drill_down_one,
    frontier_ccpm_encounter_cohort.provider_name as drill_down_two,
    encounter_date as metric_date,
    'count' as num_calculation,
    'count' as metric_type,
    'up' as direction,
    'fp_ccpm_op_visits' as metric_id,
    frontier_ccpm_encounter_cohort.visit_key as num
from
