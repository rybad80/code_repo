...
*/
ALTER PROCEDURE "dbo"."sp_CHOP_IMPACT_CATHDATA" 
...
DECLARE @ProcDxCath int
	...
	AND CATH_SRC.schedarrivaldate  >= '2019-08-01 00:00:00.000'
	ORDER BY CathID
					  ...
					  BEGIN
						...
						BEGIN TRAN
							...
							SET 
								...
								CATH_TRGT.OPERATORID = operator.CONTACTID,
								...
								CATH_TRGT.RECORDER = recorder.ContactID,
							...
							LEFT JOIN CONTACTS operator ON CATH_SRC.OPERATORID = operator.CONTACTIDFT
							LEFT JOIN CONTACTS recorder ON CATH_SRC.RECORDER = recorder.CONTACTIDFT
							WHERE AC.RowID = @i
