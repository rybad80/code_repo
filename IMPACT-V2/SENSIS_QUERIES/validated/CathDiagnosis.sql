...
WHERE POCT.PRTYPE <> 10 --Fluoro
    ...
    SELECT
        SURG_ENC_ID
        ,PRDG.IP4000 PREPROCCARDDIAGID
		,DICIP4000.MEANING DIAGNOSISNAME
		,PRDG.SEQNO SORT
  FROM CATH_STUDY STUDY JOIN SENSIS_PRDG PRDG ON STUDY.REFNO = PRDG.REFNO
                        JOIN SENSIS_DICIP4000 DICIP4000 ON DICIP4000.CODE = PRDG.IP4000
